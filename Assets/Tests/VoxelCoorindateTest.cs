...
namespace Assets.Tests
{
    public class VoxelCoorindateTest
    {
        ...
        public void TestDefaultCase()
        {
            ...
            Assert.AreEqual(voxelCoords.VoxelGroupId, "0|0|0");
        ...
        public void TestFloatCoordInNonCenterGroup()
        {
            ...
            Assert.AreEqual("1|1|1", voxelCoords.VoxelGroupId);
        ...
        public void TestFloatCoordInNegativeNonCenterGroup()
        {
            ...
            Assert.AreEqual("-2|-2|-2", voxelCoords2.VoxelGroupId);
            ...
            Assert.AreEqual("-1|0|0", voxelCoords3.VoxelGroupId);
